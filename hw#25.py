#Условие:
#создайте список из 50 элементов из всех нечетных чисел от 1 до 99, выведите его
#на экран в строку, а затем этот же список выведите в сроку, только в случайном порядке
