#Условие:
#выведите на экран список из 11 случайных целых чисел из отрезка [-1,1], выведите список на экран в строкус
#определите какой элемент в спике встречается чаще всего и выведите об этом сообщение на экран.Если 2 каких-то элемента встречаются
#одинаковое кол-во раз, то не выводить ничего
