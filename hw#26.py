#Условие:
#создайте 2 списка из 5 случайных целых чисел из отрезка [0,5] каждый,
# выведите списки на экран в 2х отдельных строках. Посчитаете среднее арифметическое элементов
#каждого списка и сообщите для какого из списков это значение оказалось больше либо сообщите что
